...
/**
 * This is the item provider adapter for a {@link glot_webapplication.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Glot_webapplicationPackage.Literals.PAGE__CONTENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Page.class)) {
			case Glot_webapplicationPackage.PAGE__CONTENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Glot_webapplicationPackage.Literals.PAGE__CONTENTS,
				 Glot_webapplicationFactory.eINSTANCE.createContent()));

		newChildDescriptors.add
			(createChildParameter
				(Glot_webapplicationPackage.Literals.PAGE__CONTENTS,
				 Glot_webapplicationFactory.eINSTANCE.createElement()));
