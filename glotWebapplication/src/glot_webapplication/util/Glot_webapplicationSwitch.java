 ...
 * @generated
 */
public class Glot_webapplicationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Glot_webapplicationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Glot_webapplicationPackage.WEBAPPLICATION: {
			...
			case Glot_webapplicationPackage.PAGE: {
			...
			case Glot_webapplicationPackage.CONTENT: {
			...
			case Glot_webapplicationPackage.ATTRIBUTE: {
			...
			case Glot_webapplicationPackage.ENTITY: {
			...
			case Glot_webapplicationPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = caseContent(element);
				if (result == null) result = caseNamedElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Glot_webapplicationPackage.FORM: {
			...
			case Glot_webapplicationPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Glot_webapplicationPackage.REFERENCES: {
				References references = (References)theEObject;
				T result = caseReferences(references);
				if (result == null) result = caseAttribute(references);
				if (result == null) result = caseNamedElement(references);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Glot_webapplicationPackage.LINKS: {
				Links links = (Links)theEObject;
				T result = caseLinks(links);
				if (result == null) result = caseNamedElement(links);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
