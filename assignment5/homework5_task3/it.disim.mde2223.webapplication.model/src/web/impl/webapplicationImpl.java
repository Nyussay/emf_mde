 ...
 *   <li>{@link web.impl.webapplicationImpl#getIndexes <em>Indexes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class webapplicationImpl extends NamedElementImpl implements webapplication {
	...
	protected EClass eStaticClass() {
		return WebPackage.Literals.WEBAPPLICATION;
	}
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<Entity>(Entity.class, this, WebPackage.WEBAPPLICATION__ENTITIES);
		}
		return entities;
	}
	...
	public EList<Index> getIndexes() {
		if (indexes == null) {
			indexes = new EObjectContainmentEList<Index>(Index.class, this, WebPackage.WEBAPPLICATION__INDEXES);
		}
		return indexes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebPackage.WEBAPPLICATION__ENTITIES:
				return ((InternalEList<?>)getEntities()).basicRemove(otherEnd, msgs);
			case WebPackage.WEBAPPLICATION__INDEXES:
