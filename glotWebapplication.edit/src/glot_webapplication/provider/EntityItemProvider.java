...
/**
 * This is the item provider adapter for a {@link glot_webapplication.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Glot_webapplicationPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(Glot_webapplicationPackage.Literals.ENTITY__REFERENCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Glot_webapplicationPackage.Literals.ENTITY__ATTRIBUTES,
				 Glot_webapplicationFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(Glot_webapplicationPackage.Literals.ENTITY__ATTRIBUTES,
				 Glot_webapplicationFactory.eINSTANCE.createReferences()));

		newChildDescriptors.add
			(createChildParameter
				(Glot_webapplicationPackage.Literals.ENTITY__REFERENCES,
				 Glot_webapplicationFactory.eINSTANCE.createReferences()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Glot_webapplicationPackage.Literals.ENTITY__ATTRIBUTES ||
			childFeature == Glot_webapplicationPackage.Literals.ENTITY__REFERENCES;
